...
/**
 * Main CoBlocks Feedback Notice Class
 */
		...
		<div class="notice updated coblocks-notice">
			<div class="coblocks-notice-inner">
				<div class="coblocks-notice-icon">
					...
					<img src="https://ps.w.org/coblocks/assets/icon-256x256.jpg" alt="<?php printf( esc_attr__( '%1$s WordPress Plugin', 'coblocks' ), esc_attr( $this->name ) ); ?>" />
				</div>
				<div class="coblocks-notice-content">
					<?php /* translators: 1. Name */ ?>
					<h3><?php printf( esc_html__( 'Are you enjoying %1$s?', 'coblocks' ), esc_html( $this->name ) ); ?></h3>
					<p>
						<?php /* translators: 1. Name, 2. Time */ ?>
						<?php printf( esc_html__( 'You have been using %1$s for %2$s now! Mind leaving a quick review to let us know know what you think? I\'d really appreciate it!', 'coblocks' ), esc_html( $this->name ), esc_html( $time ) ); ?>
					</p>
				</div>
